...
var require_react_is2 = __commonJS({
  "../../node_modules/downshift/node_modules/react-is/index.js"(exports, module2) {
    "use strict";
    if (process.env.NODE_ENV === "production") {
...
__export(src_exports, {
  ...
  Close: () => Close_default,
  DropdownMultipleCombobox: () => DropdownMultipleCombobox_default,
...
var Switch = ({ checked, label, onChange, ...rest }) => {
  ...
  return /* @__PURE__ */ import_react47.default.createElement(import_theme_ui13.Box, { sx, ...rest, onKeyPress: (e2) => ["Enter", " "].includes(e2.key) && handleClick(), onClick: handleClick, "aria-checked": checked }, /* @__PURE__ */ import_react47.default.createElement("div", null, /* @__PURE__ */ import_react47.default.createElement("div", null)));
};
Switch.defaultProps = {
  tabIndex: 0,
  onChange: () => {
...
var Downshift = /* @__PURE__ */ (() => {
  class Downshift2 extends import_react49.Component {
    constructor(_props) {
      var _this;
      super(_props);
      _this = this;
    ...
    render() {
      ...
      if (this.getRootProps.called || this.props.suppressRefError) {
        ...
        return /* @__PURE__ */ (0, import_react49.cloneElement)(element, this.getRootProps(getElementProps(element)));
      }
      if (process.env.NODE_ENV !== "production") {
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && typeof window.document !== "undefined" && typeof window.document.createElement !== "undefined" ? import_react49.useLayoutEffect : import_react49.useEffect;
function useElementIds(_ref) {
  ...
  const elementIdsRef = (0, import_react49.useRef)({
...
function useLatestRef(val) {
  const ref = (0, import_react49.useRef)(val);
  ref.current = val;
  return ref;
}
function useEnhancedReducer(reducer, initialState, props) {
  const prevStateRef = (0, import_react49.useRef)();
  const actionRef = (0, import_react49.useRef)();
  const enhancedReducer = (0, import_react49.useCallback)((state2, action2) => {
  ...
  const [state, dispatch] = (0, import_react49.useReducer)(enhancedReducer, initialState);
  const propsRef = useLatestRef(props);
  const dispatchWithProps = (0, import_react49.useCallback)((action2) => dispatch({
...
function useMouseAndTouchTracker(isOpen, downshiftElementRefs, environment, handleBlur) {
  const mouseAndTouchTrackersRef = (0, import_react49.useRef)({
    isMouseDown: false,
    isTouchMove: false
  });
  (0, import_react49.useEffect)(() => {
...
if (process.env.NODE_ENV !== "production") {
  useGetterPropsCalledChecker = function() {
    const isInitialMountRef = (0, import_react49.useRef)(true);
    for (var _len = arguments.length, propKeys = new Array(_len), _key = 0; _key < _len; _key++) {
      propKeys[_key] = arguments[_key];
    }
    const getterPropsCalledRef = (0, import_react49.useRef)(propKeys.reduce((acc, propKey) => {
      acc[propKey] = {};
      return acc;
    }, {}));
    (0, import_react49.useEffect)(() => {
    ...
    const setGetterPropCallInfo = (0, import_react49.useCallback)((propKey, suppressRefError, refKey, elementRef) => {
...
function useScrollIntoView(_ref3) {
  ...
  const shouldScrollRef = (0, import_react49.useRef)(true);
...
if (process.env.NODE_ENV !== "production") {
  useControlPropsValidator = (_ref4) => {
    ...
    const prevPropsRef = (0, import_react49.useRef)(props);
    (0, import_react49.useEffect)(() => {
      if (isInitialMount) {
        return;
      }
...
function useSelect(userProps) {
  ...
  const toggleButtonRef = (0, import_react49.useRef)(null);
  const menuRef = (0, import_react49.useRef)(null);
  const itemRefs = (0, import_react49.useRef)({});
  const shouldBlurRef = (0, import_react49.useRef)(true);
  const clearTimeoutRef = (0, import_react49.useRef)(null);
  const elementIds = useElementIds(props);
  const previousResultCountRef = (0, import_react49.useRef)();
  const isInitialMountRef = (0, import_react49.useRef)(true);
  const latest = useLatestRef({
    state,
    props
  });
  const getItemNodeFromIndex = (0, import_react49.useCallback)((index) => itemRefs.current[elementIds.getItemId(index)], [elementIds]);
  ...
  const toggleButtonKeyDownHandlers = (0, import_react49.useMemo)(() => ({
    ArrowDown(event) {
      event.preventDefault();
      dispatch({
  ...
  const menuKeyDownHandlers = (0, import_react49.useMemo)(() => ({
    ArrowDown(event) {
      event.preventDefault();
      dispatch({
  ...
  const toggleMenu = (0, import_react49.useCallback)(() => {
    dispatch({
      type: FunctionToggleMenu$1
    });
  }, [dispatch]);
  const closeMenu = (0, import_react49.useCallback)(() => {
    dispatch({
      type: FunctionCloseMenu$1
    });
  }, [dispatch]);
  const openMenu = (0, import_react49.useCallback)(() => {
    dispatch({
      type: FunctionOpenMenu$1
    });
  }, [dispatch]);
  const setHighlightedIndex = (0, import_react49.useCallback)((newHighlightedIndex) => {
    dispatch({
      type: FunctionSetHighlightedIndex$1,
      highlightedIndex: newHighlightedIndex
    });
  }, [dispatch]);
  const selectItem = (0, import_react49.useCallback)((newSelectedItem) => {
    dispatch({
  ...
  const setInputValue = (0, import_react49.useCallback)((newInputValue) => {
    dispatch({
      type: FunctionSetInputValue$1,
      inputValue: newInputValue
    });
  }, [dispatch]);
  const getLabelProps = (0, import_react49.useCallback)((labelProps) => ({
    id: elementIds.labelId,
    htmlFor: elementIds.toggleButtonId,
    ...labelProps
  }), [elementIds]);
  const getMenuProps = (0, import_react49.useCallback)(function(_temp, _temp2) {
    let {
      onMouseLeave,
      refKey = "ref",
      onKeyDown,
  ...
  const getToggleButtonProps = (0, import_react49.useCallback)(function(_temp3, _temp4) {
    let {
      onClick,
      onKeyDown,
      refKey = "ref",
  ...
  const getItemProps = (0, import_react49.useCallback)(function(_temp5) {
    let {
      item,
      index,
      onMouseMove,
...
function useControlledReducer(reducer, initialState, props) {
  const previousSelectedItemRef = (0, import_react49.useRef)();
  const [state, dispatch] = useEnhancedReducer(reducer, initialState, props);
  (0, import_react49.useEffect)(() => {
...
function useCombobox(userProps) {
  ...
  const toggleButtonRef = (0, import_react49.useRef)(null);
  const comboboxRef = (0, import_react49.useRef)(null);
  const isInitialMountRef = (0, import_react49.useRef)(true);
  const elementIds = useElementIds(props);
  const previousResultCountRef = (0, import_react49.useRef)();
  const latest = useLatestRef({
  ...
  const inputKeyDownHandlers = (0, import_react49.useMemo)(() => ({
    ArrowDown(event) {
      event.preventDefault();
      dispatch({
  ...
  const getItemProps = (0, import_react49.useCallback)(function(_temp3) {
    let {
      item,
      index,
      refKey = "ref",
  ...
  const getToggleButtonProps = (0, import_react49.useCallback)(function(_temp4) {
    let {
      onClick,
      onPress,
      refKey = "ref",
  ...
  const getInputProps = (0, import_react49.useCallback)(function(_temp5, _temp6) {
    let {
      onKeyDown,
      onChange,
      onInput,
  ...
  const getComboboxProps = (0, import_react49.useCallback)(function(_temp7, _temp8) {
    let {
      refKey = "ref",
      ref,
      ...rest
...
function useMultipleSelection(userProps) {
  ...
  const previousSelectedItemsRef = (0, import_react49.useRef)(selectedItems);
  const selectedItemRefs = (0, import_react49.useRef)();
  ...
  const selectedItemKeyDownHandlers = (0, import_react49.useMemo)(() => ({
    [keyNavigationPrevious]() {
      dispatch({
  ...
  const dropdownKeyDownHandlers = (0, import_react49.useMemo)(() => ({
  ...
  const getSelectedItemProps = (0, import_react49.useCallback)(function(_temp) {
    let {
      refKey = "ref",
      ref,
      onClick,
  ...
  const getDropdownProps = (0, import_react49.useCallback)(function(_temp2, _temp3) {
    let {
      refKey = "ref",
      ref,
      onKeyDown,
  ...
  const addSelectedItem = (0, import_react49.useCallback)((selectedItem) => {
    dispatch({
      type: FunctionAddSelectedItem,
      selectedItem
    });
  }, [dispatch]);
  const removeSelectedItem = (0, import_react49.useCallback)((selectedItem) => {
    dispatch({
      type: FunctionRemoveSelectedItem,
      selectedItem
    });
  }, [dispatch]);
  const setSelectedItems = (0, import_react49.useCallback)((newSelectedItems) => {
    dispatch({
      type: FunctionSetSelectedItems,
      selectedItems: newSelectedItems
    });
  }, [dispatch]);
  const setActiveIndex = (0, import_react49.useCallback)((newActiveIndex) => {
    dispatch({
...
function DropdownMultipleCombobox({ items: initialItems, value: initialSelectedItems, onChange, valueField, labelField }) {
  const [inputValue, setInputValue] = import_react50.default.useState("");
  ...
  return /* @__PURE__ */ import_react50.default.createElement(import_theme_ui15.Box, { sx: { position: "relative" } }, /* @__PURE__ */ import_react50.default.createElement(import_theme_ui15.Box, { sx: { position: "relative", display: "inline-flex", flexWrap: "wrap" } }, /* @__PURE__ */ import_react50.default.createElement(import_theme_ui15.Box, { sx: { display: "inline-block" }, ...getComboboxProps() }, /* @__PURE__ */ import_react50.default.createElement("input", { ...getInputProps(getDropdownProps({ preventKeyAction: isOpen })) }), /* @__PURE__ */ import_react50.default.createElement("button", { type: "button", ...getToggleButtonProps(), "aria-label": "toggle menu" }))), /* @__PURE__ */ import_react50.default.createElement("ul", { ...getMenuProps(), style: { display: isOpen ? "block" : "none" } }, isOpen && getFilteredItems(initialItems).map((item, index) => /* @__PURE__ */ import_react50.default.createElement(
    "li",
    {
    ...
    item[labelField]
  ))), selectedItems.map((selectedItem, index) => /* @__PURE__ */ import_react50.default.createElement("span", { key: `selected-item-${index}`, ...getSelectedItemProps({ selectedItem, index }) }, selectedItem[labelField], /* @__PURE__ */ import_react50.default.createElement("span", { onClick: () => removeSelectedItem(selectedItem) }, "\u2715"))));
}
...
function CircularProgress({ value = 0, height = 48, color = "currentColor", style, ...rest }) {
  ...
  return /* @__PURE__ */ import_react51.default.createElement("svg", { viewBox: "22 22 44 44", height, fill: color, style: { transform: "rotate(-90deg)", ...style }, ...rest }, /* @__PURE__ */ import_react51.default.createElement("circle", { style: { transition: "stroke-dashoffset 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms", stroke: "currentcolor", strokeDasharray: "126.920", strokeDashoffset: `${strokeDashoffset}px` }, cx: "44", cy: "44", r: "20.2", fill: "none", strokeWidth: "3.6" }));
}
function CircularProgressWithBg({ value = 0, height = 48, color = "currentColor", style, ...rest }) {
  return /* @__PURE__ */ import_react51.default.createElement(import_theme_ui16.Box, { sx: { display: "inline-flex", position: "relative" } }, /* @__PURE__ */ import_react51.default.createElement("svg", { viewBox: "22 22 44 44", height, style: { position: "absolute" } }, /* @__PURE__ */ import_react51.default.createElement("circle", { style: { stroke: "lightgray" }, cx: "44", cy: "44", r: "20.2", fill: "none", strokeWidth: "3.6" })), /* @__PURE__ */ import_react51.default.createElement(CircularProgress, { value, height, color, style: { ...style, position: "absolute" }, ...rest }));
}
function CircularProgressWithLabel({ value = 0, height = 48, color = "currentColor", hideLabel = false, style, ...rest }) {
  return /* @__PURE__ */ import_react51.default.createElement(import_theme_ui16.Box, { sx: { display: "inline-flex", position: "relative" } }, /* @__PURE__ */ import_react51.default.createElement(import_theme_ui16.Box, { sx: { display: "inline-block", width: height, height } }, /* @__PURE__ */ import_react51.default.createElement("svg", { viewBox: "22 22 44 44", height, style: { position: "absolute" } }, /* @__PURE__ */ import_react51.default.createElement("circle", { style: { stroke: "lightgray" }, cx: "44", cy: "44", r: "20.2", fill: "none", strokeWidth: "3.6" }))), /* @__PURE__ */ import_react51.default.createElement(CircularProgress, { value, height, color, style: { ...style, position: "absolute" }, ...rest }), !hideLabel && /* @__PURE__ */ import_react51.default.createElement(import_theme_ui16.Box, { sx: { top: 0, left: 0, bottom: 0, right: 0, position: "absolute", display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ import_react51.default.createElement(import_theme_ui16.Text, { sx: { fontSize: 1 } }, `${Math.round(value)}%`)));
}
...
var Menu = (0, import_styled4.default)(({ children, className, ...rest }) => /* @__PURE__ */ import_react52.default.createElement(import_theme_ui17.Box, { sx: { pb: 2, minWidth: 100 }, className, ...rest }, children))``;
var MenuItem = ({ children, className, to, ...rest }) => {
  if (to) {
    return /* @__PURE__ */ import_react52.default.createElement(import_react_router_dom2.Link, { to }, /* @__PURE__ */ import_react52.default.createElement(import_theme_ui17.Box, { sx: { cursor: "pointer", py: 2, px: 3 }, className, ...rest }, children));
  }
  return /* @__PURE__ */ import_react52.default.createElement(import_theme_ui17.Box, { sx: { cursor: "pointer", py: 2, px: 3 }, className, ...rest }, children);
};
...
function TableCellDiv({ children, options = [], onChange = () => {
  ...
  const [originalValue, setOriginalValue] = import_react53.default.useState(children);
  const [isEditing, setIsEditing] = import_react53.default.useState(false);
  const [value, setValue] = import_react53.default.useState(children || "");
  ...
  return /* @__PURE__ */ import_react53.default.createElement(import_react53.default.Fragment, null, !isEditing && /* @__PURE__ */ import_react53.default.createElement(import_theme_ui18.Box, { onKeyPress: handleDivKeyPress, tabIndex: 0, ...rest, ...bind }, value), /* @__PURE__ */ import_react53.default.createElement(import_theme_ui18.Box, { sx: { display: isEditing ? "block" : "none" } }, /* @__PURE__ */ import_react53.default.createElement(Input2, { list: "data", onKeyDown: handleInputKeyDown, ref: inputRef, value, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur }), /* @__PURE__ */ import_react53.default.createElement("datalist", { id: "data" }, options.map((option) => /* @__PURE__ */ import_react53.default.createElement("option", { key: option, value: option })))));
}
var ArrowUpIcon = () => /* @__PURE__ */ import_react53.default.createElement("svg", { viewBox: "0 0 24 24", height: 16, fill: "currentColor" }, /* @__PURE__ */ import_react53.default.createElement("path", { d: "M13,20H11V8L5.5,13.5L4.08,12.08L12,4.16L19.92,12.08L18.5,13.5L13,8V20Z" }));
var ArrowDownIcon = () => /* @__PURE__ */ import_react53.default.createElement("svg", { viewBox: "0 0 24 24", height: 16, fill: "currentColor" }, /* @__PURE__ */ import_react53.default.createElement("path", { d: "M11,4H13V16L18.5,10.5L19.92,11.92L12,19.84L4.08,11.92L5.5,10.5L11,16V4Z" }));
function SortLabel({ headerField, currentField, label, currentAscOrDesc, onChange }) {
  if (headerField === currentField) {
    return /* @__PURE__ */ import_react53.default.createElement(import_theme_ui18.Box, { onClick: () => onChange(`${headerField} ${currentAscOrDesc === "asc" ? "desc" : "asc"}`), sx: { display: "inline-flex", alignItems: "center", cursor: "pointer", textDecoration: "underline", textUnderlinePosition: "under" } }, /* @__PURE__ */ import_react53.default.createElement(import_theme_ui18.Box, { sx: { userSelect: "none" } }, label), /* @__PURE__ */ import_react53.default.createElement(import_theme_ui18.Box, { sx: { display: "inline-flex" } }, currentAscOrDesc.toLowerCase() === "desc" ? /* @__PURE__ */ import_react53.default.createElement(ArrowUpIcon, null) : /* @__PURE__ */ import_react53.default.createElement(ArrowDownIcon, null)));
  }
  return /* @__PURE__ */ import_react53.default.createElement(import_theme_ui18.Box, { onClick: () => onChange(`${headerField} asc`), sx: { display: "inline-flex", cursor: "pointer", textDecoration: "underline", textUnderlinePosition: "under" } }, label);
}
var TableContainer = (0, import_styled5.default)(import_theme_ui18.Box)`
  flex-grow: 1;
  overflow: auto;
...
`;
var Table = (0, import_styled5.default)(import_theme_ui19.Themed.table)`
  width: fit-content;
  min-width: 100%;
  table-layout: fixed;
...
var TR = (0, import_styled5.default)(import_theme_ui19.Themed.tr)`
...
`;
var TH = (0, import_styled5.default)(import_theme_ui19.Themed.th)`
  position: sticky;
  top: 0px;
  text-align: left;
  user-select: none;
...
`;
var TD = (0, import_styled5.default)(import_theme_ui19.Themed.td)`
  line-height: 1em;
...
`;
var Truncate = (0, import_styled5.default)(import_theme_ui18.Box)`
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
`;
...
function ResizableTH({ children, initialWidth = 200, minWidth = 100, maxWidth = 400, style = {}, onChange = () => {
  ...
  const [col1Width, setCol1Width] = import_react53.default.useState(initialWidth);
  ...
  return /* @__PURE__ */ import_react53.default.createElement(animated4.th, { style: { userSelect: "none", position: "sticky", top: 0, height: "3rem", backgroundColor: "var(--theme-ui-colors-elevated)", borderBottom: "1px solid var(--theme-ui-colors-hairline)", textAlign: "left", fontWeight: 500, ...style, ...styles }, ...rest }, children, /* @__PURE__ */ import_react53.default.createElement("div", { ...bind(), style: { position: "absolute", right: 0, top: 10, userSelect: "none", cursor: "col-resize" } }, /* @__PURE__ */ import_react53.default.createElement(Icon_default, { height: 20, path: "M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z" })));
}
